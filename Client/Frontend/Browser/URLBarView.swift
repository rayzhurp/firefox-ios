...
class URLBarView: UIView {
    ...
    func updateTabCount(count: Int) {
        ...
        let rotationPoint = CGPoint(x: tabsButton.center.x, y: tabsButton.center.y + CGRectGetHeight(tabsButton.frame))

        var newFlipTransform = CATransform3DIdentity
        newFlipTransform = CATransform3DTranslate(newFlipTransform, rotationPoint.x - tabsButton.center.x, rotationPoint.y - center.y, 0)
        ...
        newFlipTransform = CATransform3DTranslate(newFlipTransform, tabsButton.center.x - rotationPoint.x, center.y - rotationPoint.y, 0)
        newTabsButton.titleLabel?.layer.transform = newFlipTransform

        var oldFlipTransform = CATransform3DIdentity
        oldFlipTransform = CATransform3DTranslate(oldFlipTransform, -rotationPoint.x - tabsButton.center.x, -rotationPoint.y - center.y, 0)
        ...
        oldFlipTransform = CATransform3DTranslate(oldFlipTransform, tabsButton.center.x + rotationPoint.x, center.y + rotationPoint.y, 0)
        oldFlipTransform = CATransform3DRotate(oldFlipTransform, CGFloat(M_PI), 1.0, 0.0, 0.0)
