...
class ActionViewController: UINavigationController, ClientPickerViewControllerDelegate, InstructionsViewControllerDelegate
{
    ...
    override func viewDidLoad() {
        ...
        if profile.getAccount() == nil {
            ...
            self.pushViewController(instructionsViewController, animated: false)
        } else {
